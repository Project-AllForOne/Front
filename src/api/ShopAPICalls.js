...
const transformPerfumeResponse = (perfumeResponse) => {
    return {
        id: perfumeResponse.id.toString(), // 백엔드는 Long, 프론트는 String
        ...
        originalPrice: null, // 백엔드에 할인가 필드가 없으므로 null
        image: perfumeResponse.imageUrlList && perfumeResponse.imageUrlList.length > 0 
            ? perfumeResponse.imageUrlList[0] // 첫 번째 이미지를 메인 이미지로 사용
        ...
        detailImages: {
            ...
            ingredients: perfumeResponse.imageUrlList && perfumeResponse.imageUrlList.length > 1 
                ? perfumeResponse.imageUrlList[1] 
                : perfumeResponse.imageUrlList[0] || '/images/default-ingredients.png',
            process: perfumeResponse.imageUrlList && perfumeResponse.imageUrlList.length > 2 
                ? perfumeResponse.imageUrlList[2] 
                : perfumeResponse.imageUrlList[0] || '/images/default-process.png',
            brand: perfumeResponse.imageUrlList && perfumeResponse.imageUrlList.length > 3 
                ? perfumeResponse.imageUrlList[3] 
                : perfumeResponse.imageUrlList[0] || '/images/default-brand.png',
            lifestyle: perfumeResponse.imageUrlList && perfumeResponse.imageUrlList.length > 4 
                ? perfumeResponse.imageUrlList[4] 
                : perfumeResponse.imageUrlList[0] || '/images/default-lifestyle.png'
        }
    };
};
